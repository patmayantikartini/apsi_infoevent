...
<html lang="en">
  ...
  <body>
  <?php
  // TOTAL BOOKING BELUM DI READ
  $qbooking = mysql_query("select*from booking where `read`='0'") or die (mysql_error());
  $totalUnRead = mysql_num_rows($qbooking);
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Admin InfoEvent</a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="event.php">Data Event</a></li>
                <li><a href="kategori_event.php">Data Kategori Event</a></li>
              </ul>
            </li>
            <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Laporan <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li><a href="laporan.php">Laporan Event</a></li>
                      <li>Laporan Booking</a></li>
                      <li>Laporan Absensi</a></li>
                    </ul>
                  </li>
            <li><a href="booking.php">Booking
